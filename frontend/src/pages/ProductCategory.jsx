...
import '../scss/components/CategoryComponent.scss';
    ...
    <Row className="g-4">
      {categories.map((category, index) => (
        ...
        <Card className="category-card">
          ...
          {/* Place the shop button outside the Card.ImgOverlay */}
          <Button className="shop-button" onClick={() => navigateToCategory(category.path)}>
            Shop
          </Button>
        </Card>
      </Col>      
